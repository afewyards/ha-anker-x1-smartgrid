...
def test_evening_hour_sees_past_noon_trough():
    ...
    prices = {9: 0.20, 10: 0.15, 11: 0.13, 12: 0.13, 13: 0.15,
              14: 0.19, 15: 0.25, 16: 0.28, 17: 0.34}
...
def test_future_secondary_trough_not_overblocked():
    ...
    prices = {1: 0.12, 2: 0.10, 3: 0.12, 4: 0.15, 5: 0.18, 6: 0.20, 7: 0.19,
              8: 0.17, 9: 0.16, 10: 0.15, 11: 0.14, 12: 0.13, 13: 0.13,
              14: 0.18, 15: 0.25, 16: 0.30}
    slots = _slots(base, prices)
