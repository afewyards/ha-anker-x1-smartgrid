...
def test_charge_price_ceiling_none_curve_is_identical():
    ...
    cfg = Config(round_trip_eff=0.85)
    assert scheduler.charge_price_ceiling(0.40, cfg) == scheduler.charge_price_ceiling(
        0.40, cfg, eta_curve=None
    )
