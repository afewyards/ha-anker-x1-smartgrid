...
def _cfg():
    return Config(
        capacity_kwh=10.0, soc_floor=10.0, soc_target=90.0, max_charge_w=3000.0, eta_charge=0.95, round_trip_eff=0.90
    )
...
def test_optimize_grid_dt60_golden():
    ...
    out = optimize_grid(
        pv, load, price, soc_start=50.0, cfg=_cfg(), window_start_h=0, window_len=24, dt_h=1.0, slots_per_day=24
    )
